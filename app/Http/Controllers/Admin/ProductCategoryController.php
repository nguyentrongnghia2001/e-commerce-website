...
class ProductCategoryController extends Controller
{
    ...
    public function __construct(ProductCategoryServiceInterface $productCategoryServiceInterface)
    {
        $this->productCategoryService = $productCategoryServiceInterface;
    }
