                ...
                <div class="card-body">
                    <form method="post" action="admin/user" enctype="multipart/form-data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                ...
                                <small class="form-text text-muted">
                                    Bấm vào đây để chọn ảnh đại diện
                                </small>
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="password" id="password" placeholder="Mật khẩu" type="password" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="password_confirmation" id="password_confirmation" placeholder="Xác nhận mật khẩu" type="password" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input name="street_address" id="street_address" placeholder="Địa chỉ" type="text" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required type="number" name="phone" id="phone" placeholder="Số điện thoại" class="form-control" value="">
                            </div>
                        </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                {{-- <select required name="level" id="level" class="form-control" disabled> --}}
                                    ...
                                    {{-- @endforeach --}}
                                {{-- </select> --}}
                                 <input disabled required type="text" name="level" id="level" placeholder="Người dùng" class="form-control" value="Người dùng">
                            </div>
                        </div>
