    ...
    <div class="app-page-title">
        <div class="page-title-wrapper">
            ...
            <div class="page-title-actions">
                <a href="./admin/madein/create" class="btn-shadow btn-hover-shine mr-3 btn btn-primary">
                ...
                <div class="table-responsive">
                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center text-muted">#{{ $madein->id }}</td>
                                <td>
                                    <div class="widget-content p-0">
                                        <div class="widget-content-wrapper">
                                            <div class="widget-content-left flex2">
                                                <div class="widget-heading">{{ $madein->name }}</div>
                                            </div>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="text-center">
                                    <a href="./admin/madein/{{ $madein->id }}/edit" data-toggle="tooltip" title="Edit" data-placement="bottom" class="btn btn-outline-warning border-0 btn-sm">
                                        <span class="btn-icon-wrapper opacity-8">
                                            <i class="fa fa-edit fa-w-20"></i>
                                        </span>
                                    </a>
                                    <form class="d-inline" action="admin/madein/{{ $madein->id }}" method="post">
                                        @csrf
                                        @method('DELETE')
