            ...
            <div class="page-title-heading">
                ...
                <div>
                    ...
                    <div class="page-title-subheading">
                        Xem, tạo, cập nhật, xoá và quản lý.
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <div class="position-relative row form-group">
                        <label for="" class="col-md-3 text-md-right col-form-label">Tất cả ảnh</label>
                        <div class="col-md-9 col-xl-8">
                                ...
                                @foreach ($productImages as $productImage)
                                    ...
                                    <li class="float-left d-inline-block mr-2 mb-2" style="position: relative; width: 32%;">
                                        <form action="admin/product/{{ $product->id }}/image/{{ $productImage->id }}" method="post">
                                            ...
                                            <button type="submit" onclick="return confirm('Bạn có muốn xóa?')" class="btn btn-sm btn-outline-danger border-0 position-absolute">
                                                <i class="fas fa-times"></i>
                                            </button>
                                        </form>
                                        <div style="width: 100%; height: 220px; overflow: hidden;">
                                            <img  src="./front/img/products/{{ $productImage->path ?? 'noi-image.png' }}"
                                            alt="Image">
                                        </div>
                                    </li>
                                    ...
                                    <form method="post" action="admin/product/{{ $product->id }}/image" enctype="multipart/form-data">
                                        ...
                                        <div style="width: 100%; max-height: 220px; overflow: hidden;">
                                            <img style="width: 100%; cursor: pointer;" 
                                                class="thumbnail"
                                                data-toggle="tooltip" title="Bấm vào đây để thêm ảnh" data-placement="bottom"
                    ...
                    <div class="position-relative row form-group mb-1">
                        <div class="col-md-9 col-xl-8 offset-md-3">
                            <a href="./admin/product" class="btn-shadow btn-hover-shine btn btn-primary">
