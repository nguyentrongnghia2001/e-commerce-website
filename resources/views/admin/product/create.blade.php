                    ...
                    <form method="post" action="admin/product" enctype="multipart/form-data">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8 d-flex justify-center align-items-center">
                                <input required name="price" class="form-control text-sm" id="price" placeholder="Giá bán" type="number" class="form-control" value="">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8 d-flex justify-center align-items-center">
                                <input required name="discount" id="discount" placeholder="Giảm giá" type="number" class="form-control" value="">
                                <div class="input-group-append">
                                    <div class="input-group-text"><strong>VNĐ</strong></div>
                                </div>
                            </div>
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8 d-flex justify-center align-items-center">
                                <input required name="weight" id="weight" placeholder="Thể tích" type="number" class="form-control" value="">
                                <div class="input-group-append">
                        ...
                        <div class="position-relative row form-group">
                            ...
                            <div class="col-md-9 col-xl-8">
                                <input required name="sku" id="sku" placeholder="Mã sản phẩm" type="text" class="form-control" value="">
                            </div>
                        </div>

                        <div class="position-relative row form-group">
                            <label for="status" class="col-md-3 text-md-right col-form-label">Thạng thái</label>
                            <div class="col-md-9 col-xl-8">
