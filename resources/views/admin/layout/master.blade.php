...
<head>
    ...
    <title>Admin - DongNaiBeauty</title>
    ...
    <div class="app-container app-theme-white body-tabs-shadow fixed-header fixed-sidebar">
        <div class="app-header header-shadow">
            <div class="app-header__logo">
                <div class="logo-src">
                    <img src="./dashboard/assets/images/beauty.png" alt="">
                </div>
                                ...
                                <div class="widget-content-left">
                                    <div class="btn-group">
                                        <a data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="p-0 btn">
                                            <img width="42" class="rounded-circle" src="front/img/user/{{ Auth::user()->avatar ?? 'default-user.png' }}" alt="">
                                ...
                                <ul>
                                    ...
                                    <li>
                                        <a href="./admin/order" class="{{ (request()->segment(2) == 'order') ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Đơn Hàng Bán
                                        </a>
                                    </li>
                                    <li>
                                        <a href="./admin/importinvoice" class="{{ (request()->segment(2) == 'importinvoice') ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Đơn Hàng Nhập
                                        </a>
                                    </li>
                                    ...
                                    <li>
                                        <a href="./admin/madein" class="{{ (request()->segment(2) == 'madein') ? 'mm-active' : '' }}">
                                            <i class="metismenu-icon"></i>Xuất Xứ
                                        </a>
                                    </li>
                                    <li>
                                    ...
                                    <!-- <li>
                                    <a href="./admin/importinvoice" class="{{ (request()->segment(2) == 'importinvoice') ? 'mm-active' : '' }}">
                                        <i class="metismenu-icon"></i>Quản Lý Đơn Hàng Nhập
                                    </a>
                                </li> -->
