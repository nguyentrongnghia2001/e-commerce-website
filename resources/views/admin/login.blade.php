...
<head>
    ...
    <title>Login | Admin - DongNaiBeauty</title>
    <meta name="viewport" content="width=device-width, initial-scale=1, maximum-scale=1, user-scalable=no, shrink-to-fit=no" />
    <meta name="description" content="DongNai Beauty">
                                ...
                                <form class="" method="post" action="">
                                    ...
                                    <div class="modal-footer clearfix">
                                        <div class="float-right">
                                            <button type="submit" class="btn btn-primary btn-lg">Đăng nhập vào admim</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                        </div>
                        <div class="text-center text-white opacity-8 mt-3">Copyright © DongNaiBeauty 2023</div>
                    </div>
                </div>
            </div>
        </div>
